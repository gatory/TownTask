...
namespace AssetPath {
    ...
    constexpr const char* LIBRARY_BACKGROUND = "assets/floor_2.png";
    constexpr const char* HOUSE_BACKGROUND = "assets/floor_2.png";
    ...
    constexpr const char* DESK_SPRITE = "assets/table.png";
